...
def draw_line_graph(graph_data):
    ...
    #输出
    plotly.offline.plot(figure, filename="C:/Users/liuchenhu/Desktop/文档/gzbd_line_graph.html", image="png");
...
def draw_bar_graph(graph_data):
    ...
    # 输出
    plotly.offline.plot(figure, filename="C:/Users/liuchenhu/Desktop/文档/gzbd_bar_graph.html", image="png");
